    ...
    <table class="mt-3 table table-hover table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $l['CELULAR'] ?></td>
                <td>
                    <a href="alterar_motorista.php?COD_MOTORISTA=<?= $l['COD_MOTORISTA'] ?>" class="btn btn-warning"> Alterar </a>
                    <a href="excluir_motorista.php?COD_MOTORISTA=<?= $l['COD_MOTORISTA'] ?>" class="btn btn-danger"> Excluir </a>
                </td>
            </tr>
            <?php
                }
