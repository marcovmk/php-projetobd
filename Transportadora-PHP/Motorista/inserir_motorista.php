    ...
    <form action="" method="POST">
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" maxlenght ="9" onkeypress ="return event.charcode >= 48 && event.charcode" class="form-control" name="num_carteira">
            </div>
        </div>
        <div class="row">
            <div class="col">
...
<?php
    if ($_POST){
        ...
        if($nome != "" && $descricao != "" && $num_carteira != "" && $celular != ""){
